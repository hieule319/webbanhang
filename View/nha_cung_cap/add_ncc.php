                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post" novalidate="novalidate">
                            <div class="form-group has-success">
                                ...
                                <input type="text" class="form-control cc-name valid" name="tenncc">
                            </div>
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control cc-cvc" name="sdt">
                            ...
                            <div>
                                <button id="payment-button" type="submit" name="add_ncc" class="btn btn-lg btn-info btn-block">
